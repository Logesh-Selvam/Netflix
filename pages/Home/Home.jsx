...
import TitleCardes from "../../components/TitleCards/TitleCardes.jsx";
import Footer from "../../components/Footer/Footer.jsx";
import Title2Cardes from "../../components/Title2/Title2.jsx";
import Title3Cardes from "../../components/Title3/Title3.jsx";
import Title4Cardes from "../../components/Title4/Title4.jsx";
import Title5Cardes from "../../components/Title5/Title5.jsx";
import box1 from '../../assets/cards/box1.jpg'
import box2 from '../../assets/cards/box2.jpg'
import box3 from '../../assets/cards/box3.jpg'
import box4 from '../../assets/cards/box4.jpg'
import box5 from '../../assets/cards/box5.jpg'
import box6 from '../../assets/cards/box6.jpg'
import box7 from '../../assets/cards/box7.jpg'
import box8 from '../../assets/cards/box8.jpg'
import box9 from '../../assets/cards/box9.jpg'
import box10 from '../../assets/cards/box10.jpg'
import Title6Cardes from "../../components/Title6/Title6.jsx";
import Title7Cardes from "../../components/Title7/Title7.jsx";
import Title8Cardes from "../../components/Title8/Title8.jsx";
    ...
    <div className="home">
        ...
        <div className="hero">
          ...
          <div className="hero-caption">
            ...
            <p>Growing up in a remote forest cabin with his dad, Gus learns lessons about survival and the dangers that lurk beyond the fence to the outside world.</p>
            <div className="hero-btns">
              <button>
                <img height={29} width={26} src={Play} alt="" className="btn" />Play
                {/* <FaPlay/> Play  */}
              </button>
              <button>
                <img height={29} width={26} src={Info} alt="" className="btn dark-btn" /> More Info
        ...
        <Title4Cardes/>
        <Title5Cardes/>
        <p className="loki"><h2>Top 10 Movies & TV Shoew in India Tody</h2></p>
        <div className="boxers">
          <div className="boxer-track">
            <div className="boxer">
            <svg id="rank-1" width="240" height="200" viewBox="-20 0 70 154" className="svg-icon">
        <path stroke="#595959" strokeLinejoin="square" strokeWidth="4" d="M35.377 152H72V2.538L2 19.362v30.341l33.377-8.459V152z"></path>
        </svg>
        <img height={190} width={410} className="boxer-img" src={box6} alt="" />
        {/* </div> */}
        <div className="boxer">
        <svg id="rank-2" width="240" height="200" viewBox="0 0 80 154" className="svg-icon">
            ...
            <img height={190} width={410} className="boxer-img" src={box3} alt="" />
        </div>
        <div className="boxer">
        <svg id="rank-3" width="240" height="200" viewBox="0 0 80 154" className="svg-icon">
        <path stroke="#595959" strokeLinejoin="square" strokeWidth="4" d="M3.809 41.577h33.243c1.3-2.702 3.545-4.947 6.674-6.72 3.554-2.015 7.83-3.01 12.798-3.01 5.555 0 10.14 1.11 13.723 3.376 3.839 2.427 5.782 6.283 5.782 11.315 0 4.553-1.853 8.395-5.473 11.38-3.547 2.926-8.18 4.37-13.821 4.37H41.44v28.366h16.77c5.572 0 10.275 1.227 14.068 3.711 4.02 2.633 6.071 6.581 6.071 11.616 0 5.705-1.943 9.975-5.853 12.562-3.658 2.42-8.292 3.61-13.863 3.61-5.205 0-9.82-.94-13.827-2.836-3.698-1.75-6.32-4.272-7.785-7.529H2.33c2.096 12.089 7.761 21.65 17.028 28.78C29.242 148.175 42.594 152 59.476 152c10.706 0 20.175-1.783 28.42-5.337 8.185-3.528 14.575-8.486 19.208-14.884 4.595-6.346 6.896-13.938 6.896-22.837 0-6.952-1.93-13.494-5.81-19.666-3.815-6.07-9.68-10.367-17.683-12.908l-5.46-1.735 5.353-2.04c6.659-2.538 11.667-6.338 15.083-11.412 3.431-5.096 5.142-10.806 5.142-17.181 0-8.471-2.262-15.778-6.787-21.985-4.574-6.275-10.7-11.17-18.408-14.696C77.683 3.775 69.109 2 59.687 2 44.084 2 31.515 5.816 21.91 13.415c-9 7.119-15.025 16.486-18.101 28.162z"></path>
        </svg>
        <img height={190} width={410} className="boxer-img" src={box5} alt="" />
        </div>
        <div className="boxer">
        <svg id="rank-4" width="240" height="200" viewBox="0 0 81 154" className="svg-icon">
            <path stroke="#595959" strokeLinejoin="square" strokeWidth="4" d="M72 152h35.333v-30.977H128V92.497h-20.667V2H69.89L2 92.712v28.311h70V152zM36.202 92.188l35.93-47.998v47.998h-35.93z">
            </path>
            </svg>
            <img height={190} width={410} className="boxer-img" src={box4} alt="" />
        </div>
        <div className="boxer">
        <svg id="rank-5" width="240" height="200" viewBox="0 0 81 154" className="svg-icon">
        ...
        <img height={190} width={410} className="boxer-img" src={box7} alt="" />
        </div>
        <div className="boxer">
        <svg id="rank-6" width="240" height="200" viewBox="0 0 81 154" className="svg-icon">
            ...
            <img height={190} width={410} className="boxer-img" src={box1} alt="" />
        </div>
        <div className="boxer">
        <svg id="rank-7" width="240" height="200" viewBox="0 0 78 154" className="svg-icon">
        <path stroke="#595959" strokeLinejoin="square" strokeWidth="4" d="M113,2 L2,2 L2,33.4022989 L75.9665929,33.4022989 L21.22571,152 L60.28102,152 L113,32.7672283 L113,2 Z"></path>
        </svg>
        <img height={190} width={410} className="boxer-img" src={box2} alt="" />
        </div>
        <div className="boxer">
        <svg id="rank-8" width="240" height="200" viewBox="0 0 77 154" className="svg-icon">
        ...
        <svg id="rank-10" width="340" height="200" viewBox="0 0 140 154" className="svg-icon">
            ...
            <img height={190} width={410} className="boxer-img" src={box10} alt="" />
        </div>
            </div>
          </div>  
        </div>
